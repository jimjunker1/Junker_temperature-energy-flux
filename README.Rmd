...
Package versions dependencies are documented with the `renv` package version 0.16.0 and explicitly with the `renv.lock` file. The `renv` auto-loader has been deactivated, but can be re-activated with `renv::activate()`.
