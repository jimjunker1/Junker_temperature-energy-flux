...
This repository contains the code and document files for Junker, J. R., W. F. Cross, J. M. Hood, J. P. Benstead, A. D. Huryn, D. Nelson, J. S. Ólafsson, and G. M. Gíslason, "*Environmental warming increases the importance of high-turnover energy channels in stream food webs*", accepted for publication as an article in **Ecology**. The archived Zenodo repository can be found here:

[![DOI](https://zenodo.org/badge/581618244.svg)](https://zenodo.org/doi/10.5281/zenodo.10455904)
