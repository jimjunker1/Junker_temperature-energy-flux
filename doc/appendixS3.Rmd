...
Appendix S3: Supporting information for Junker, J. R., W. F. Cross, J. M. Hood, J. P. Benstead, A. D. Huryn, D. Nelson, J. S. Ólafsson, and G. M. Gíslason, *Environmental warming increases the importance of high-turnover energy channels in stream food webs*. Ecology.
...
```{r TBP workflow, fig.cap="Appendix S3: Figure S1. Graphical depiction of the workflow to estimate consumption fluxes of organic matter to consumers using the trophic basis of production method."}
