...
here::i_am('doc/appendixS2.Rmd')
source(here::here("packages.R"))

```

Appendix S2: Supporting information for James R. Junker, Wyatt F. Cross, James M. Hood, Jonathan P. Benstead, Alexander D. Huryn, Daniel Nelson, Jón S. Ólafsson, and Gísli M. Gíslason, *Environmental warming increases the importance of high-turnover energy channels in stream food webs*. Ecology.
