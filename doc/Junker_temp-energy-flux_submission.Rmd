...
Open Research Statement: All data and code used in this work are publicly available at the following link: https://github.com/jimjunker1/Junker_temperature_energy-flux. Upon acceptance, all data and code will be submitted to relevant repositories (e.g., Dryad, Zenodo) for archival. 

Key words: energy flux; climate change; food webs; species traits; temperature; environmental filtering
