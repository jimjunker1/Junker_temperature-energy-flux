...
publicly available and archived at Junker [-@junkerEnergyFlux] and Zenodo
...
```{r figure 1, echo=FALSE, warning=FALSE, message=FALSE, fig.width=7, fig.height=5, dpi = 600}

drake::loadd(spp_traitsVtemp)
ggsave("./doc/accepted version/Figure 1.svg", plot = spp_traitsVtemp[['fig1_plot']], width = 7, height = 5)
...
```{r figure 2, echo = FALSE, warning = FALSE, message = FALSE, fig.width=7.5, fig.height=8, dpi = 600}

drake::loadd(annual_spp_flux_fig)
drake::loadd(spp_flux_dist)
fig2 = ggarrange(spp_flux_dist[['full_plot']], annual_spp_flux_fig, ncol = 2, widths = c(4/7,3/7))#gridExtra::grid.arrange( spp_flux_dist[["full_plot"]],annual_spp_flux_fig, ncol = 2, layout_matrix = cbind(1,1,1,1,2,2,2))
ggsave("./doc/accepted version/Figure 2.svg", plot = fig2, width = 7.5, height = 8)
```
...
```{r figure 3, echo =FALSE, warning=FALSE, message=FALSE, fig.width=5, fig.height=4, dpi = 600}

drake::loadd(M_lorenz_skew_fig)
ggsave("./doc/accepted version/Figure 3.svg", plot = M_lorenz_skew_fig, width = 5, height = 4)
...
```{r figure 4, echo = FALSE, warning=FALSE, message=FALSE, fig.width=5, fig.height=4, dpi = 600}

drake::loadd(PB_lorenz_skew_fig)
ggsave("./doc/accepted version/Figure 4.svg", plot = PB_lorenz_skew_fig, width = 5, height = 4)
