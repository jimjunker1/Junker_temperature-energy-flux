...
##' @title
##' @param full_diet_df
model_diet_props <- function(full_diet_df = full_diet_df,
                             model = "dirichlet",...) {
  ...
  # saveRDS(diet_df, file = "./data/diet_df.rds")
  # diet_df = readRDS(file = "./data/diet_df.rds")
  ...
  #                   warmup = 1000,
  #                   iter = 3e3, 
  #                   file = "./data/diet-poiss_brms_m", # cache model (can be removed)
  #                   backend = 'cmdstanr',
  #                   rerun = 'on-change',
